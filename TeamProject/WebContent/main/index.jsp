            ...
            <div class="container w-100 h-100">
                <div class="row  d-flex align-items-center justify-content-between w-100 h-100">
                    <div class="footer_text col-md-auto">
                        ...
                        <p class="f-14 m-0"><i class="fa-solid fa-location-dot" style="margin-right: 10px;"></i>경기도 성남시 분당구
                            불정로386번길 35</p>
                        <p class="f-14 m-0"><i class="fa-solid fa-phone" style="margin-right: 10px;"></i>031-778-2300</p>
