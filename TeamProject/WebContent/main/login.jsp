				...
				<form action="<%= request.getContextPath()%>/login" method="get">
					<div class="container login_container ">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-10">
								<input type="text" 
									class="form-control border border-light bg-black text-white"
						...
						<div class="row" style="margin-bottom: 35px;">
							...
							<div class="col-sm-10">
								<input type="password"
									class="form-control border border-light bg-black text-white"
									placeholder="비밀번호" name="pw" id="pw">
							</div>
						</div>
						<div
							class="m-0 d-flex align-items-center justify-content-center w-100 ">
							<a href="<%= request.getContextPath()%>/main/join.jsp"
								class="btn border border-light text-white mx-1"
								style="width: 110px;">회원가입</a> <input type="submit"
								class="btn btn-light mx-1" value="확인" style="width: 110px;">
						</div>
					</div>
				</form>
			</div>
